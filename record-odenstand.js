...
const HTML_PATH = path.resolve(__dirname, 'odenstand.html');
const OUTPUT_DIR = path.resolve(__dirname, 'output');
const WEBM_PATH = path.join(OUTPUT_DIR, 'odenstand-raw.webm');
const MP4_PATH = path.join(OUTPUT_DIR, 'odenstand-reel.mp4');

// 11 slides: 2800+2700+2300+2600+2400+2500+2300+2400+2200+2300+3800 = 28300ms
const TOTAL_DURATION = 28300;
const BUFFER = 2000;

(async () => {
  console.log('Starting Oden Stand Instagram Reel recording...');
