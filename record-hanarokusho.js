...
const HTML_PATH = path.resolve(__dirname, 'hanarokusho.html');
const OUTPUT_DIR = path.resolve(__dirname, 'output');
const WEBM_PATH = path.join(OUTPUT_DIR, 'hanarokusho-raw.webm');
const MP4_PATH = path.join(OUTPUT_DIR, 'hanarokusho-course-reel.mp4');

// 11 slides: hook(3) + course(3) + 7 courses + reservation(3) + CTA(4.2) = 31.7s
const TOTAL_DURATION = 31700;
const BUFFER = 2000;

(async () => {
  console.log('Starting 花緑青コース Reel recording...');
